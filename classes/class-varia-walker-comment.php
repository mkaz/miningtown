				...
				<footer class="comment-meta">
					<div class="comment-author vcard">
						...
						printf(
							...
							wp_kses(
								__( '%s <span class="screen-reader-text says">says:</span>', 'miningtown' ),
								array(
									'span' => array(
										'class' => array(),
									),
					...
					<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'miningtown' ); ?></p>
					<?php endif; ?>
				</footer><!-- .comment-meta -->
